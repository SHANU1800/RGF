/**
 * Right Castle Renderer Module
 * Renders the BLUE team castle on the right side
 */

const RightCastleRenderer = {
    /**
     * Draws the right (BLUE) castle
    ...
    render(ctx, scaleX, scaleY, scaleLengthX, scaleLengthY, worldX, groundY, canvasWidth, canvasHeight, gateOpenAnim) {
        ...
        ctx.fillStyle = '#3498db';  // BLUE banner
        ctx.beginPath();
...
if (typeof window !== 'undefined') {
    window.RightCastleRenderer = RightCastleRenderer;
}
